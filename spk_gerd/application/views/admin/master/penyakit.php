              ...
              <tbody>
                ...
                foreach($penyakit as $g):
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-info btn-icon mb-2 me-4" onclick="edit(`<?=$g->kode_penyakit?>`)" data-bs-toggle="modal" data-bs-target="#rotateleftModal">
                      ...
                      <button class="btn btn-danger btn-icon mb-2 me-4" onclick="hapus(`<?=$g->kode_penyakit?>`)">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Form Penyakit</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        </button>
      </div>
      <form action="javascript:void(0)" method="POST" id="form_penyakit">
          ...
          <div id="flFormsGrid" class="col-lg-12 layout-spacing">
            <div class="row">
              <div class="col-md-6 p-2">
                ...
                <input type="text" id="kode_penyakit" name="kode_penyakit" class="form-control" placeholder="Kode Penyakit" aria-label="Kode Penyakit" required="">
              </div>
              <div class="col-md-6 p-2">
                <label for="nama_penyakit" class="form-label">Nama Penyakit</label>
                <input type="text" class="form-control" name="nama_penyakit" id="nama_penyakit" placeholder="Nama Penyakit" aria-label="Nama Penyakit" required="">
              </div>
            </div>
...
<script>
    ...
    function tambah(){
      ...
      metode = "tambah";
      $("#kode_penyakit").removeAttr('readonly');
    }

    function edit(kode_penyakit){
      $("#form_penyakit")[0].reset();
      $(".modal-title").text('EDIT DATA PENYAKIT');
      metode = "edit";
      $.ajax({
        url:"<?=base_url('admin/Master/edit_penyakit')?>/"+kode_penyakit,
        type:"GET",
        dataType:"JSON",
        success: function(data){
          $("#kode_penyakit").attr('readonly','readonly');
    ...
    $("#form_penyakit").submit(function(e){
     e.preventDefault();
     $.ajax({
      url:"<?=base_url('admin/Master/save_penyakit/')?>"+metode,
      type:"POST",
      data:$("#form_penyakit").serialize(),
      dataType:"JSON",
      success:function(data){
        if(data.status == true){
         Swal.fire(
    ...
    function hapus(kode_penyakit){
      Swal.fire({
        ...
        if (result.isConfirmed) {
         $.ajax({
          url:"<?=base_url('admin/Master/delete_penyakit');?>/"
          +kode_penyakit,
          type:"POST",
          dataType:"JSON",
          cache:false,
